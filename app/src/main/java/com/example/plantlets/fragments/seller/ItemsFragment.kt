...
import com.example.plantlets.utils.Extensions.blockingClickListener
...
class ItemsFragment : Fragment(), ItemClickListener {
    ...
    override fun onCreateView(
        ...
        (requireActivity() as SellerHomeActivity).showBottomNav()
        ...
        if (dialogCheck) {
            ...
            with(dialogBinding) {
                ...
                btnSetFilter.setOnClickListener {
                    itemViewModel.sellerItemFillter = ItemFillter(
